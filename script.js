...
function createConfetti() {
    ...
    const colors = ['#ff4081', '#f06292', '#ffeb3b', '#4caf50', '#2196f3', '#9c27b0', '#ff9800'];

    for (let i = 0; i < 40; i++) {
        const piece = document.createElement('div');
        piece.classList.add('floating-heart');

        // Mix emoji confetti and colored square confetti
        if (Math.random() > 0.4) {
            piece.innerHTML = confettiPieces[Math.floor(Math.random() * confettiPieces.length)];
